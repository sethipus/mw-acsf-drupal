(function ($, Drupal) {
  Drupal.behaviors.productContentPairUp = {
    attach: function (context) {
      $(context).find('.product-content-pair-up').once('productContentPairUp').each(function () {
        const contentPairUpBlock = this;
        ...
        const listener = () => {
          if (isInViewport(contentPairUpBlock)) {
            updateElementsPositions(contentPairUpBlock);
          }
        };
