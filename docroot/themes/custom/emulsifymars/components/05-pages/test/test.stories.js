...
import {productContentPairUpModuleArticleCard,productContentPairUpModuleRecipeCard, productContentPairUpModuleProductCard} from "../../02-molecules/product-content-pair-up/product-content-pair-up.stories";
import {recipeBodyTemplate} from "../../03-organisms/recipe-body/recipe-body.stories";
...
export const cardsTest = () => {
  ...
  const components = [
    ReactDOMServer.renderToStaticMarkup(recipeBodyTemplate()),
    ...
    ReactDOMServer.renderToStaticMarkup(productContentPairUpModuleArticleCard()),
    ReactDOMServer.renderToStaticMarkup(productContentPairUpModuleRecipeCard()),
    ReactDOMServer.renderToStaticMarkup(productContentPairUpModuleProductCard()),
  ];
