...
use Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ContentPairUpBlockCollector;
use Drupal\Tests\UnitTestCase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * @coversDefaultClass \Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ContentPairUpBlockCollector
 * @group mars
 * @group mars_content_hub
 */
class ContentPairUpBlockCollectorTest extends UnitTestCase {

  /**
   * System under test.
   *
   * @var \Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ContentPairUpBlockCollector
   */
  private $collector;
  ...
  protected function setUp(): void {
    ...
    $this->collector = new ContentPairUpBlockCollector(
  ...
  public function testShouldOnCalculateSectionComponentDependencies() {
    ...
    $this->sectionComponentMock
      ->expects($this->once())
      ->method('getPluginId')
      ->willReturn('product_content_pair_up_block');
