...
use Drupal\mars_content_hub\EventSubscriber\UnserializeContentField\ProductFieldUnserializer;
use Drupal\node\Entity\Node;
use Drupal\Tests\UnitTestCase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * @coversDefaultClass \Drupal\mars_content_hub\EventSubscriber\UnserializeContentField\ProductFieldUnserializer
 * @group mars
 * @group mars_content_hub
 */
class ProductFieldUnserializerTest extends UnitTestCase {

  /**
   * System under test.
   *
   * @var \Drupal\mars_content_hub\EventSubscriber\UnserializeContentField\ProductFieldUnserializer
   */
  private $serializer;
  ...
  protected function setUp(): void {
    ...
    $this->serializer = new ProductFieldUnserializer(
