...
use Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ManualRecommendationBlockCollector;
use Drupal\Tests\UnitTestCase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * @coversDefaultClass \Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ManualRecommendationBlockCollector
 * @group mars
 * @group mars_content_hub
 */
class ManualRecommendationBlockCollectorTest extends UnitTestCase {

  /**
   * System under test.
   *
   * @var \Drupal\mars_content_hub\EventSubscriber\DependencyCollector\ManualRecommendationBlockCollector
   */
  private $collector;
  ...
  protected function setUp(): void {
    ...
    $this->collector = new ManualRecommendationBlockCollector(
  ...
  public function testShouldOnCalculateSectionComponentDependencies() {
    ...
    $this->sectionComponentMock
      ->expects($this->once())
      ->method('getPluginId')
      ->willReturn('recommendations_module');
