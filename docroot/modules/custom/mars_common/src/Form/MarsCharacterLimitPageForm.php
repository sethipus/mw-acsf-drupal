...
class MarsCharacterLimitPageForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['ui_disclaimer'] = array(
      '#type' => 'label',
      '#title' => $this->t('Important: Once the character count limitation is changed, the onus lies with the Site admin/ Content creator to verify how the modification in the Character Limit page is reflecting in the front end before publishing.'),
    );
    ...
    $form['article_header']['eyebrow'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Eyebrow'),
      '#default_value' => !empty($site_label_config->get('eyebrow')) ? $site_label_config->get('eyebrow') : static::EYEBROW,
      '#required' => TRUE,
      '#description' => static::FIELD_LIMIT_DESCRIPTION
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('eyebrow', $form_state->getValue('eyebrow'))
  ...
  public function resetForm(array &$form, FormStateInterface $form_state){
    ...
    $config->set('eyebrow', static::EYEBROW)
