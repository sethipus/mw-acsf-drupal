...
class FooterBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $build['#cta_button_label'] = $build['#cta_button_label'] = isset($conf['cta_button_label']) ? $this->languageHelper->translate($conf['cta_button_label']) : strtoupper($this->languageHelper->translate('See All'));
