...
class SalsifyFieldsMap {
  ...
  public const SALSIFY_FIELD_MAPPING_PRODUCT_VARIANT = [
    ...
    'field_product_family_master' => [
      'salsify:id' => 'CMS: Product Variant Family Master',
      'salsify:data_type' => 'boolean',
    ],
    'field_product_size' => [
      'salsify:id' => 'Net Content',
      'salsify:data_type' => 'string',
    ],
    'field_product_serving_size' => [
      'salsify:id' => 'Serving Size',
      'salsify:data_type' => 'string',
    ],
    'field_product_servings_per' => [
      'salsify:id' => 'Servings per Container',
      'salsify:data_type' => 'string',
    ],
    'field_product_allergen_warnings' => [
      'salsify:id' => 'Allergen Statement',
      'salsify:data_type' => 'string',
    ],
    'field_product_ingredients' => [
      'salsify:id' => 'Complete Ingredient Statement',
      'salsify:data_type' => 'string',
    ],
    'field_product_description' => [
      'salsify:id' => 'CMS: Description',
      'salsify:data_type' => 'string',
    ],
    'field_product_cooking_instruct' => [
      'salsify:id' => 'Brandbank Cooking Guidelines',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_protein_daily' => [
      'salsify:id' => 'Protein Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_total_fat_daily' => [
      'salsify:id' => 'Total Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_saturated_daily' => [
      'salsify:id' => 'Saturated Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_trans_fat_daily' => [
      'salsify:id' => 'Trans Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_cholesterol_daily' => [
      'salsify:id' => 'Cholesterol Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_sodium_daily' => [
      'salsify:id' => 'Sodium Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_product_carb' => [
      'salsify:id' => 'Total Carbohydrate',
      'salsify:data_type' => 'string',
    ],
    'field_product_carb_daily' => [
      'salsify:id' => 'Total Carbohydrate Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_dietary_daily' => [
      'salsify:id' => 'Dietary Fiber Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_sugars_daily' => [
      'salsify:id' => 'Sugars Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_allergen_warnings' => [
      'salsify:id' => 'Dual Allergen Statement',
      'salsify:data_type' => 'string',
    ],
    'field_dual_ingredients' => [
      'salsify:id' => 'Dual Complete Ingredient Statement',
      'salsify:data_type' => 'string',
    ],
    'field_dual_protein' => [
    ...
    'field_dual_protein_daily' => [
      'salsify:id' => 'Dual Protein Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_dual_calories' => [
    ...
    'field_dual_calories_fat' => [
      'salsify:id' => 'Dual Calories from Fat',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_total_fat_daily' => [
      'salsify:id' => 'Dual Total Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_saturated_daily' => [
      'salsify:id' => 'Dual Saturated Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_trans_fat_daily' => [
      'salsify:id' => 'Dual Trans Fat Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_cholesterol_daily' => [
      'salsify:id' => 'Dual Cholesterol Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_dual_sodium' => [
    ...
    'field_dual_sodium_daily' => [
      'salsify:id' => 'Dual Sodium Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_dual_carb' => [
      'salsify:id' => 'Dual Total Carbohydrate',
      'salsify:data_type' => 'string',
    ],
    'field_dual_carb_daily' => [
      'salsify:id' => 'Dual Total Carbohydrate Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_dietary_daily' => [
      'salsify:id' => 'Dual Dietary Fiber Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_dual_sugars' => [
    ...
    'field_dual_added_sugars_daily' => [
      'salsify:id' => 'Dual Added Sugars Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_dual_sugars_daily' => [
      'salsify:id' => 'Dual Sugars Pct Daily Value',
      'salsify:data_type' => 'string',
    ],
    'field_dual_calcium' => [
    ...
    'field_dual_riboflavin' => [
      'salsify:id' => 'Dual Riboflavin',
      'salsify:data_type' => 'string',
    ],
    ...
    'field_product_consumption_1' => [
      'salsify:id' => 'Consumption Context',
      'salsify:data_type' => 'string',
    ],
    'field_product_consumption_2' => [
      'salsify:id' => 'Dual Consumption Context',
      'salsify:data_type' => 'string',
    ],
    'field_product_key_image' => [
      'salsify:id' => 'CMS: Image 1',
      'salsify:data_type' => 'digital_asset',
    ],
    'field_product_image_1' => [
      'salsify:id' => 'CMS: Image 2',
      'salsify:data_type' => 'digital_asset',
    ],
    'field_product_image_2' => [
      'salsify:id' => 'CMS: Image 3',
      'salsify:data_type' => 'digital_asset',
    ],
    'field_product_image_3' => [
      'salsify:id' => 'CMS: Image 4',
      'salsify:data_type' => 'digital_asset',
    ],
    'field_product_image_4' => [
      'salsify:id' => 'CMS: Image 5',
      'salsify:data_type' => 'digital_asset',
    ],
  ...
  public const SALSIFY_FIELD_MAPPING_PRODUCT = [
    'field_product_category' => [
      'salsify:id' => 'CMS: Category Computed',
      'salsify:data_type' => 'enumerated',
    ],
    'field_product_segment' => [
      'salsify:id' => 'Amazon Segment',
      'salsify:data_type' => 'string',
    ],
    'field_product_name' => [
      'salsify:id' => 'CMS: Product Name',
      'salsify:data_type' => 'string',
    ],
    'field_product_description' => [
      'salsify:id' => 'CMS: Description',
    ...
    'field_product_format' => [
      'salsify:id' => 'CMS: Format',
      'salsify:data_type' => 'enumerated',
    ],
    'field_product_market' => [
      'salsify:id' => 'CMS: Market',
      'salsify:data_type' => 'string',
    ],
    // Enumerated.
    'field_product_trade_description' => [
      'salsify:id' => 'Trade Item Description',
      'salsify:data_type' => 'enumerated',
    ],
    // Enumerated.
    'field_product_flavor' => [
      'salsify:id' => 'CMS: Flavor',
      'salsify:data_type' => 'enumerated',
    ],
    'field_product_variants' => [
      'salsify:id' => 'CMS: Child variants',
      'salsify:data_type' => 'entity_ref',
    ],
    // There is a custom logic for fields with 'complex' data type in
    // SalsifyImportField class.
    'field_meta_tags' => [
      'salsify:id' => 'CMS: Meta tags',
      'salsify:data_type' => 'complex',
    ],
    'field_product_generated' => [
      'salsify:id' => 'CMS: multipack generated',
      'salsify:data_type' => 'boolean',
    ],
  ];
