 ...
 *
 * It will help you to render a checkbox widgets with preview image.
 *
 * Example of usage:
 *
 * @code
 ...
 * @endcode
 *
 * @FormElement("lighthouse_gallery_checkbox")
 */
class LighthouseGalleryCheckbox extends Checkbox {
